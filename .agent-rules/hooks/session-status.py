...
Advisory only — never blocks. (SessionStart hooks can't block regardless,
but this is invoked as a directly-executable file, not via `python3`, for
consistency with the other advisory hook in this directory.)
"""
