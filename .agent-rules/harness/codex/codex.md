...
Read this after `../../AGENTS.md`. Codex-only mechanics live here; shared policy stays in `AGENTS.md` and `../../hooks/guardlib/`.
...
reasoning effort. The senior is the interactive model, whatever the user
set in the Codex UI. Escalation: Astra low, rarely — it often dies
mid-prompt. `agents.job_max_runtime_seconds`
